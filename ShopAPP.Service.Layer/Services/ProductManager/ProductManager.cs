...
namespace ShopAPP.Service.Layer.Services.ProductManager;
public class ProductManager : IProductManager
{
  private IProductRepository _productRepository;
    ...
    public ValidationResult Validate(Product instance)
    {
        throw new NotImplementedException();
    }

    public Task<ValidationResult> ValidateAsync(Product instance, CancellationToken cancellation = default)
    {
        throw new NotImplementedException();
    }
